...
. "C:\programming\auto_remaster\venv\Scripts\Activate.ps1"; python optimize_flux_vae.py --model-path "dim/fal_FLUX.2-Tiny-AutoEncoder_v6_2x_flux_klein_4B_lora_v2" --output-dir "flux_vae_tiny_trt_v2" --fp16 --latent-dim 32 --with-pixel-shuffle
